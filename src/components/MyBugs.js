  ...
  return (
    <div className="my-bugs-page">
      ...
      <div className="my-bugs-container">
        ...
        {/* Available Bugs to Request */}
        <div className="bugs-section">
          <div className="section-header">
            <h2>Available Bugs to Work On</h2>
          </div>
          ...
          <div className="bugs-grid">
            {bugs
              .filter(bug => 
                bug.status === 'Open' && 
                !bug.assignedTo && 
                bug.reporter !== currentUser?.name &&
                !bug.workRequests?.some(req => req.author === currentUser?.name)
              )
              .map(bug => (
                <div key={bug.id} className="bug-card">
                  <div className="bug-header">
